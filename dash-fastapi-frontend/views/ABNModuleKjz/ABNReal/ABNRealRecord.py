...
from callbacks.ABNRealKjz_c import ABNRealRecord_c

RECORD_INTERVAL = 10000  # 容器刷新时间间隔
...
def render_ABNRealRecord():
    return [
        html.Div(
            [
                dcc.Store(id='ABNReal-RealRecord-store-kjz',data=[]),
                dcc.Store(id='ABNReal-RealRecord-click-store-kjz', data=[]),
                html.Div(id='ABNReal-RealRecord-interval-kjz'),
                html.Div(id='temp-record-interval-kjz-div'),
                # dcc.Interval(id='temp-record-interval-kjz', interval=RECORD_INTERVAL, n_intervals=1,disabled=True),
                ...
                fac.AntdTable(
                    ...
                    id='ABNReal-RealRecord-table-kjz',
        ...
        fac.AntdDivider(
            "判读流程监控",
            size="small",
            id="ABN_real_record_divider-kjz"
        ),
        html.Div(
            html.Div(
                # "点击上方查看判读流程",
                id="ABN_real_record_gojs-kjz",
                style={
                    'fontSize': 18,
