...
from callbacks.ABNRealKjz_c import ABNRealModule_c


def render_ABNRealModule():
    return [
        html.Div(
            id="ABN-interval-parent-kjz"
        ),
        dcc.Location(id='url-kjz', refresh=False),
        dcc.Store(id='ABN-real-module-store-kjz'),
        dcc.Store(id='ABN-real-module-store-clicktable-kjz'),
        dcc.Store(id='ABN-real-module-store-clicktable-data-kjz'),
        dcc.Store(id='ABN-real-module-store-clicktable-dataDesc-kjz'),
        dcc.Store(id='ABN-real-module-store-no-output-kjz'),
        dcc.Store(id='ABN-Check-YC-Modal-store-kjz'),
        fuc.FefferyFullscreen(
            id='fullscreen-gojs-kjz',
            targetId='ABN-real-module-gojs-kjz'
        ),
        fac.AntdButton(
            "误报管理",
            id="ABN-real-module-warn-manager-kjz",
            style={"marginBottom":10,"float":"right"}
        ),
        html.Div(
            fac.AntdTable(
                id="ABN-real-module-table-kjz",
                columns=[
                    ...
                    {'title': '更新时间', 'dataIndex': 'updateTime','width': '250px','renderOptions': {'renderType': 'ellipsis'},},
                    ...
                    [
                        ...
                        fac.AntdCol(
                            [
                                fac.AntdCard(
                                    html.Div(
                                        id="ABNReal-recent-record-card-kjz",
                                        style={
                                            'width': '100%',
                                            "height": 240,
                                            "overflowY": "auto",
