...
from callbacks.ABNRealKjz_c import ABNRealWatch_c
                ...
                html.Div(
                    fac.AntdForm(
                        [
                            fac.AntdFormItem(
                                fac.AntdInput(
                                    id='abn-search-anomaly-no-input-kjz',
                                    placeholder='请输入故障编号',
                                    autoComplete='off',
                                    allowClear=True,
                                    style={'width': 240},
                            ...
                            fac.AntdFormItem(
                                fac.AntdInput(
                                    id='abn-search-anomaly-name-input-kjz',
                                    placeholder='请输入故障名称',
                                    autoComplete='off',
                                    allowClear=True,
                                    style={'width': 240},
                            ...
                            fac.AntdFormItem(
                                fac.AntdInput(
                                    id='abn-search-payload-name-input-kjz',
                                    placeholder='请输入载荷名称',
                                    autoComplete='off',
                                    allowClear=True,
                                    style={'width': 240},
                            ...
                            fac.AntdFormItem(
                                fac.AntdSelect(
                                    id='abn-search-data-type-select-kjz',
                                    options=[
                                        {'label': '遥测数据', 'value': 'anomaly'},
                                        {'label': '工程数据', 'value': 'eng'},
                                        {'label': '参数数据', 'value': 'parameter'}
                                    ],
                                    placeholder='请选择数据类型',
                                    style={'width': 200},
                                    allowClear=True
                        ...
                        [
                            fac.AntdFormItem(
                                fac.AntdDateRangePicker(
                                    id='abn-search-anomaly-date-range-picker-kjz',
                            ...
                            fac.AntdFormItem(
                                fac.AntdButton(
                                    '搜索',
                                    id='abn-search-submit-button-kjz',
                                    type='primary',
                                    icon=fac.AntdIcon(
                                        icon='antd-search'
                                    ),
                            ...
                            fac.AntdFormItem(
                                fac.AntdButton(
                                    '重置',
                                    id='abn-search-reset-button-kjz',
                                    icon=fac.AntdIcon(
                                        icon='antd-sync'
                                    ),
                                ),
