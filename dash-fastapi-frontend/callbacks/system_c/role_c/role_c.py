...
@app.callback(
    ...
    Input('role-menu-perms-radio-fold-unfold', 'value'),
...
@app.callback(
    ...
    Input('role-menu-perms-radio-all-none', 'value'),
    State('role-menu-perms', 'treeData'),
    prevent_initial_call=True,
)
...
@app.callback(
    ...
    Input('role-menu-perms-radio-parent-children', 'value'),
    prevent_initial_call=True,
)
...
@app.callback(
    output=dict(
        ...
        fold_unfold=Output('role-menu-perms-radio-fold-unfold', 'value'),
        all_none=Output('role-menu-perms-radio-all-none', 'value'),
        radio_parent_children=Output(
            'role-menu-perms-radio-parent-children', 'value'
        ),
