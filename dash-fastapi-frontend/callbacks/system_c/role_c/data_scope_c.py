...
@app.callback(
    ...
    Input('role-dept-perms-radio-fold-unfold', 'value'),
...
@app.callback(
    ...
    Input('role-dept-perms-radio-all-none', 'value'),
    State('role-dept-perms', 'treeData'),
    prevent_initial_call=True,
)
...
@app.callback(
    ...
    Input('role-dept-perms-radio-parent-children', 'value'),
    prevent_initial_call=True,
)
