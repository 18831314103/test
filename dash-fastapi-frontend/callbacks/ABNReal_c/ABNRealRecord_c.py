...
@app.callback(
    [
        Output('ABNReal-RealRecord-store', 'data'),
        # Output('ABNReal-RealRecord-click-store', 'data', allow_duplicate=True),
    ],
    Input('temp-record-interval', 'n_intervals'),
    [
        State('ABNMode-Tabs', 'activeKey'),
        State('ABNReal-RealRecord-click-store', 'data'),
    ],
...
@app.callback(
    Output('ABNReal-RealRecord-table', 'data', allow_duplicate=True),
    Input('ABNReal-RealRecord-store', 'data'),
    prevent_initial_call=True
...
@app.callback(
    [
        Output('temp-record-interval-div', 'children')
    ],
...
def initial_load(activeKey):
    if activeKey == '故障模式全局监控':
        return [dcc.Interval(id='temp-record-interval', interval=RECORD_INTERVAL),]
    else:
...
@app.callback(
    [
        # Output('test_ouput', 'children'),
        Output('ABNReal-RealRecord-click-store', 'data', allow_duplicate=True),
        Output('ABN_real_record_divider', 'children'),
        Output('ABN_real_record_gojs', 'children', allow_duplicate=True),
    ],
    [
        Input('ABNReal-RealRecord-table', 'nClicksCell'),
        Input('ABNReal-RealRecord-table', 'nDoubleClicksCell'),
    ],
    [
        # State('table-click-event-demo', 'enableCellClickListenColumns'),
        # State('table-click-event-demo', 'recentlyCellClickColumn'),
        State('ABNReal-RealRecord-table', 'recentlyCellClickRecord'),
...
app.clientside_callback(
    ClientsideFunction(namespace='clientside', function_name='render_goChart_ABN_real_record'),
    Output('ABN_real_record_gojs', 'children', ),
    Input('ABNMode-Tabs', 'activeKey'),
    Input('ABNReal-RealRecord-click-store', 'data'),
)