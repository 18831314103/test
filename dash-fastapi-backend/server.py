...
from module_admin.controller.chat_controll import chatControll
...
from module_admin.controller.alarm_record_controller import alarmRecordController
from module_admin.controller.key_PAM_controller import keyPAMController
...
controller_list = [
    ...
    {'router': chatControll, 'tags': ['模型问答模块']},
    ...
    {'router': alarmRecordController, 'tags': ['故障信息查询模块']},
    {'router': keyPAMController, 'tags': ['关键参数模块']},
